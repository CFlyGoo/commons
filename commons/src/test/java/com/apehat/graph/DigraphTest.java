...
public class DigraphTest {
  ...
  public void testGetAdjacentFirstVertices() {
    for (Class<?> cls : getSample()) {
      ...
      assertEquals(digraph.getAdjacentFirstVertices(cls), ADJACENT_FIRST_CLASSES.get(cls));
    }
  }
  ...
  public void testGetAdjacentReachableVertices() {
    for (Class<?> cls : getSample()) {
      ...
      assertEquals(digraph.getAdjacentReachableVertices(cls), ADJACENT_REACHABLE_CLASSES.get(cls));
    }
  }
